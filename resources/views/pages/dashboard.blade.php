      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        <div class="row align-items-xl-center gy-5">
          ...
          <div class="col-xl-5 content">
            <h3>About Us</h3>
            <h2>Aplikasi ini sengaja di buat </h2>
            <p>Untuk meminimalisir kesalahan dan kecurangan para guru dan murid saat absensi kehadiran ke sekolah dan absensi pulang dan harapan yang di ingin kan semuanya berjalan dengan baik tidak ada hambatan,berikut data data yang sudah absen.</p>
            ...
            <div class="row gy-4 icon-boxes">
              ...
              <div class="col-md-6" data-aos="fade-up" data-aos-delay="200">
                <div class="icon-box">
                  ...
                  <h3>Prodi DKV</h3>
                  <p>Absensi Khusus Anak Jurusan Desain Komunikasi Visual</p>
                </div>
              </div> <!-- End Icon Box -->
              ...
              <div class="col-md-6" data-aos="fade-up" data-aos-delay="300">
                <div class="icon-box">
                  ...
                  <h3>Prodi AKL</h3>
                  <p>Absensi Khusus Anak Jurusan Agribisnis Keuangan Lembaga</p>
                </div>
              </div> <!-- End Icon Box -->
              ...
              <div class="col-md-6" data-aos="fade-up" data-aos-delay="400">
                <div class="icon-box">
                  ...
                  <h3>Prodi TKR</h3>
                  <p>Absensi Khusus Anak Jurusan Teknik Kendaraan Ringan</p>
                </div>
              </div> <!-- End Icon Box -->
              ...
              <div class="col-md-6" data-aos="fade-up" data-aos-delay="500">
                <div class="icon-box">
                  ...
                  <h3>Jumlah data absen</h3>
                  <p>Jumlah data absensi yang terkumpul setiap prodi/jurusan </p>
                </div>
              </div> <!-- End Icon Box -->
